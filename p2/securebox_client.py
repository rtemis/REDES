...
class securebox_client:
    ...
    def __init__(self, authorization):
        ...
        # Command for encrypt file from server
        self.parser.add_argument(
            '--encrypt',
            nargs=1,
            metavar='File ID',
            help='Encrypt the file associated with the given ID.'
        )

        # Command for sign file from server
        self.parser.add_argument(
            '--sign',
            nargs=1,
            metavar='File ID',
            help='Sign the file associated with the given ID.'
        )

        # Command for encrypt and sign file from server
        self.parser.add_argument(
            '--enc_sign',
            nargs=1,
            metavar='File ID',
            help='Sign and enrypt the file associated with the given ID.'
        )
